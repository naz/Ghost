...
/**
 * Checks if primary key index exists in the table.
 *
 * @param {string} tableName - name of the table to check primary key constraint in
 * @param {Object} transaction - connection object containing knex reference
 * @param {Object} transaction.knex - knex instance
 */
...
/**
 * Adds a primary key index to the table over the given columns.
 *
